...
---@field DisableSpriteOptimizations fun()
---@field OnBeforeSerialize fun()
---@field OnAfterDeserialize fun()
---@field SetNativeSize fun()
---@field CalculateLayoutInputHorizontal fun()
---@field CalculateLayoutInputVertical fun()
---@field IsRaycastLocationValid fun(screenPoint:UnityEngine.Vector2, eventCamera:UnityEngine.Camera):boolean
