---@class GraphicRaycaster:EventSystems.BaseRaycaster
---@field sortOrderPriority number
---@field renderOrderPriority number
---@field ignoreReversedGraphics boolean
---@field blockingObjects GraphicRaycaster.BlockingObjects
---@field blockingMask LayerMask
---@field eventCamera Camera
---@field priority number
---@field rootRaycaster EventSystems.BaseRaycaster
...
---@field Raycast fun(self:GraphicRaycaster, eventData:EventSystems.PointerEventData, resultAppendList:System.Collections.Generic.List`1[[EventSystems.RaycastResult, UI, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@field ToString fun(self:EventSystems.BaseRaycaster):string
