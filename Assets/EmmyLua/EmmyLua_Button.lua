...
---@field onClick Button.ButtonClickedEvent
...
---@field OnPointerClick fun(self:Button, eventData:EventSystems.PointerEventData)
---@field OnSubmit fun(self:Button, eventData:EventSystems.BaseEventData)
