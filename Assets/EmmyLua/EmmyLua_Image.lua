...
---@field fillMethod Image.FillMethod
...
---@field defaultETC1GraphicMaterial Material
...
---@field DisableSpriteOptimizations fun(self:Image)
---@field OnBeforeSerialize fun(self:Image)
---@field OnAfterDeserialize fun(self:Image)
---@field SetNativeSize fun(self:Image)
---@field CalculateLayoutInputHorizontal fun(self:Image)
---@field CalculateLayoutInputVertical fun(self:Image)
---@field IsRaycastLocationValid fun(self:Image, screenPoint:Vector2, eventCamera:Camera):boolean
