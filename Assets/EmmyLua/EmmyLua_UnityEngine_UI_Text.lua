...
---@field FontTextureChanged fun()
---@field GetGenerationSettings fun(extents:UnityEngine.Vector2):UnityEngine.TextGenerationSettings
---@field GetTextAnchorPivot fun(anchor:UnityEngine.TextAnchor):UnityEngine.Vector2
---@field CalculateLayoutInputHorizontal fun()
---@field CalculateLayoutInputVertical fun()
