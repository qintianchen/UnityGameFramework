---@class UIEventListener:MonoBehaviour
...
---@field OnPointerClick fun(self:UIEventListener, eventData:EventSystems.PointerEventData)
---@field OnPointerDown fun(self:UIEventListener, eventData:EventSystems.PointerEventData)
---@field OnPointerUp fun(self:UIEventListener, eventData:EventSystems.PointerEventData)
---@field OnBeginDrag fun(self:UIEventListener, eventData:EventSystems.PointerEventData)
---@field OnDrag fun(self:UIEventListener, eventData:EventSystems.PointerEventData)
---@field OnEndDrag fun(self:UIEventListener, eventData:EventSystems.PointerEventData)
---@field OnSelect fun(self:UIEventListener, eventData:EventSystems.BaseEventData)
