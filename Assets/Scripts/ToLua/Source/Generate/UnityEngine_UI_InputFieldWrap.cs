...
public class UnityEngine_UI_InputFieldWrap
{
	...
	static int DORewind(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.UI.InputField.DORewind");
			}
		}
		catch (Exception e)
		{
	...
	static int DORestart(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.UI.InputField.DORestart");
			}
		}
		catch (Exception e)
		{
	...
	static int DOGoto(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.UI.InputField.DOGoto");
			}
		}
		catch (Exception e)
		{
	...
	static int DOKill(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.UI.InputField.DOKill");
			}
		}
		catch (Exception e)
		{
	...
	static int DOComplete(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.UI.InputField.DOComplete");
			}
		}
		catch (Exception e)
		{
