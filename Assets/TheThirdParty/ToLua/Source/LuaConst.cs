...
{
    public static string luaDir = Application.dataPath + "/TheThirdParty/ToLua/Lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/TheThirdParty/ToLua/ToLua/Lua";        //tolua lua文件目录
