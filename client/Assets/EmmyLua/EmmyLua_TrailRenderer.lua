...
---@field SetPosition fun(self:TrailRenderer, index:number, position:Vector3)
---@field GetPosition fun(self:TrailRenderer, index:number):Vector3
---@field Clear fun(self:TrailRenderer)
---@field BakeMesh fun(self:TrailRenderer, mesh:Mesh, useTransform:boolean)
---@field BakeMesh fun(self:TrailRenderer, mesh:Mesh, camera:Camera, useTransform:boolean)
---@field GetPositions fun(self:TrailRenderer, positions:Vector3[]):number
---@field SetPositions fun(self:TrailRenderer, positions:Vector3[])
---@field AddPosition fun(self:TrailRenderer, position:Vector3)
---@field AddPositions fun(self:TrailRenderer, positions:Vector3[])
---@field SetPositions fun(self:TrailRenderer, positions:Unity.Collections.NativeArray`1[[Vector3, CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@field SetPositions fun(self:TrailRenderer, positions:Unity.Collections.NativeSlice`1[[Vector3, CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@field GetPositions fun(self:TrailRenderer, positions:Unity.Collections.NativeArray`1[[Vector3, CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]]):number
