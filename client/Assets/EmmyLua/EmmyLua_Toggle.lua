...
---@field Rebuild fun(self:Toggle, executing:CanvasUpdate)
---@field LayoutComplete fun(self:Toggle)
---@field GraphicUpdateComplete fun(self:Toggle)
---@field SetIsOnWithoutNotify fun(self:Toggle, value:boolean)
---@field OnPointerClick fun(self:Toggle, eventData:EventSystems.PointerEventData)
---@field OnSubmit fun(self:Toggle, eventData:EventSystems.BaseEventData)
...
---@field OnPointerDown fun(self:Selectable, eventData:EventSystems.PointerEventData)
